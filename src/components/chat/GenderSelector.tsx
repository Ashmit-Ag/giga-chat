        ...
        {options.map(option => {
          ...
          return (
            ...
            >
              ...
              {isLocked && (
                <div className="absolute -top-2 -right-2 bg-linear-to-r from-orange-500 via-rose-500 to-amber-500 rounded-full p-1.5 shadow-xl border border-[#0e1326]">
